...
public class User {
    ...
    @Generated(hash = 83307032)
    public User(Long id, String googleId, String firstName, String familyName,
            String email) {
        this.id = id;
    ...
    public List<Contact> getContactList() {
        if (contactList == null) {
            ...
            List<Contact> contactListNew = targetDao._queryUser_ContactList(id);
            synchronized (this) {
                if (contactList == null) {
